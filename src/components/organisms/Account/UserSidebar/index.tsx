...
export function UserSidebar() {
  ...
  return (
    <div className='h-fit w-full rounded-lg bg-textDarkGray px-4 py-10 dark:bg-[#33383F] md:w-[unset]'>
      <UserAvatar />
      {/* for desktop */}
        ...
        {menu.map((item) => (
          <div
            ...
            className={clsx(
              ...
              item.value === getView ? 'border-b-1 text-title dark:text-white' : 'text-gray',
            )}
          >
