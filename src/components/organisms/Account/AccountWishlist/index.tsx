...
const columns: ColumnsType<IData> = [
      ...
      <div className='flex items-center gap-4'>
        ...
        <div className='flex items-center gap-4'>
          ...
          <div className='flex flex-col gap-2'>
            <span className='text-sm font-semibold text-title'>{product}</span>
            <span className='text-sm text-gray'>Color: {record.color}</span>
          </div>
        </div>
      </div>
    ),
  },
  {
    ...
    dataIndex: 'price',
    key: 'price',
    render: (price) => <span className='text-sm text-title'>{price}</span>,
  },
  {
    title: 'Action',
    dataIndex: 'action',
