...
const Offers = () => {
  return (
    <div className='mb-10 flex flex-col-reverse gap-[60px] bg-bgWhiteGray pt-[60px] md:mb-20 md:flex-row md:gap-[72px] md:pt-0'>
      ...
      <div className='flex w-full flex-col justify-center gap-6 px-8 md:w-2/4 md:px-0 md:pr-40'>
        <div className='flex flex-col gap-4'>
          ...
          <h2 className='m-0 text-[34px] font-medium tracking-[-0.4px] text-active md:text-[40px]'>
            Hurry up! 30% OFF
          </h2>
          <p className='m-0 max-w-[452px] text-sm text-active md:text-xl'>
            It’s more affordable than ever to give every room in your home a stylish makeover
          </p>
        </div>

        <div className='flex flex-col gap-3'>
          <p className='m-0 text-base text-active'>Offer expires in:</p>
