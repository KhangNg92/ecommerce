...
const Discount = () => {
  return (
    <div className='relative flex w-full items-center justify-center gap-2 bg-bgWhiteGray px-8 py-2 dark:bg-bgDarkGray md:px-4'>
      <div className='flex items-center gap-3'>
        <DiscountIcon />
        <div className='flex items-baseline gap-2'>
          <span className='text-black dark:text-white'>
            <span className='text-xs md:text-sm'>30% off storewide</span>
            <span className='hidden text-xs md:inline md:text-sm'> — Limited time!</span>
          </span>
